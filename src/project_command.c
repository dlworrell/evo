...
#define EVO_PROJECT_COMMAND_EXECUTION_CAPABILITIES (EVO_PROJECT_COMMAND_CAPABILITY_DIRECT_ARGV | EVO_PROJECT_COMMAND_CAPABILITY_CPU_LIMIT | EVO_PROJECT_COMMAND_CAPABILITY_ADDRESS_SPACE_LIMIT | EVO_PROJECT_COMMAND_CAPABILITY_PROCESS_LIMIT | EVO_PROJECT_COMMAND_CAPABILITY_STORAGE_LIMIT | EVO_PROJECT_COMMAND_CAPABILITY_OUTPUT_LIMIT | EVO_PROJECT_COMMAND_CAPABILITY_WALL_TIMEOUT | EVO_PROJECT_COMMAND_CAPABILITY_FILESYSTEM_ISOLATION | EVO_PROJECT_COMMAND_CAPABILITY_NETWORK_ISOLATION | EVO_PROJECT_COMMAND_CAPABILITY_DESCENDANT_CLEANUP | EVO_PROJECT_COMMAND_CAPABILITY_MEASUREMENT)
